...
pathForOutputH5 = os.path.join(os.path.dirname(__file__), 'LSTM Model', 'model.h5')
pathForOutputJson = os.path.join(os.path.dirname(__file__), 'LSTM Model', 'model.json')
