...
pathForOutputH5 = os.path.join(os.path.dirname(__file__), 'Keras Model', 'model.h5')
pathForOutputJson = os.path.join(os.path.dirname(__file__), 'Keras Model', 'model.json')



print("Save Model")
model.save(pathForOutputH5)

model_json = model.to_json()
with open(pathForOutputJson, "w") as json_file:
    json_file.write(model_json)

print("FINISH Saveing..")
